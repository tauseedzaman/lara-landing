...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('lara-landing.landing.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('template') is-invalid @enderror"
                                ...
                                <option value="template1" {{ old('template', $page->template) == 'template1' ? 'selected' : '' }}>Template 1</option>
                                <option value="template2" {{ old('template', $page->template) == 'template2' ? 'selected' : '' }}>Template 2</option>
                                <option value="template3" {{ old('template', $page->template) == 'template3' ? 'selected' : '' }}>Template 3</option>
                            </select>
                            @error('template')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('language') is-invalid @enderror"
                                    ...
                                    <option value="es" {{ old('language', $page->language) == 'es' ? 'selected' : '' }}>Spanish</option>
                                    <option value="fr" {{ old('language', $page->language) == 'fr' ? 'selected' : '' }}>French</option>
                                    <option value="de" {{ old('language', $page->language) == 'de' ? 'selected' : '' }}>German</option>
                                </select>
                                @error('language')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="show_header"
                                           name="show_header" value="1" {{ old('show_header', $page->show_header) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="show_footer"
                                           name="show_footer" value="1" {{ old('show_footer', $page->show_footer) ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="border p-2 text-center" id="metaImagePreview" style="min-height: 150px;">
                                        @if($page->meta_image)
                                            <img src="{{ asset('storage/' . $page->meta_image) }}" id="metaImagePreviewImg" class="img-fluid" alt="Preview">
                                        @else
                                    ...
                                    @if($page->meta_image)
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="checkbox" id="remove_meta_image" name="remove_meta_image" value="1">
                                            <label class="form-check-label" for="remove_meta_image">Remove current image</label>
                                        </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('tracking_scripts') is-invalid @enderror"
                                      id="tracking_scripts" name="tracking_scripts" rows="3">@json(old('tracking_scripts', json_decode($page->tracking_scripts)), JSON_PRETTY_PRINT)</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('custom_css') is-invalid @enderror"
                                      id="custom_css" name="custom_css" rows="3">{{ json_decode($page->custom_css ?? '') }}</textarea>
                            @error('custom_css')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('custom_js') is-invalid @enderror"
                                      id="custom_js" name="custom_js" rows="3">{{ json_decode($page->custom_js) }}</textarea>
                            @error('custom_js')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i> Update Landing Page
                        </button>
                    </div>
                </div>
            </form>
